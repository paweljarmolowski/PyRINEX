...
#######################################################################################################    
    def calculatin_sat_XYZ(self,epochFrame):
        ...
        X=(x_prim * math.cos(OMEGA) - y_prim * math.sin(OMEGA) * math.cos(inklinacja))
        Y=(x_prim * math.sin(OMEGA) + y_prim * math.cos(inklinacja) * math.cos(OMEGA))
        Z=(y_prim * math.sin(inklinacja))
...
# Rinex 3.11
wroclaw_navigation = RINEXnav('/home/pawel/Master_thesis_Pawel/WROC00POL_R_20193160000_01D_GN.rnx',1)
...
for first_ten in range(1,37):
    wroclaw_navigation = RINEXnav('/home/pawel/Master_thesis_Pawel/WROC00POL_R_20193160000_01D_GN.rnx',first_ten)
    wroclaw_navigation.read_navigation_file()
    wroclaw_navigation.to_pandas_DataFrame(satellites)
    wroclaw_navigation.calculatin_sat_XYZ(epochFrame)
